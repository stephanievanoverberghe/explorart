...
type PricingModel = 'one_off' | 'included' | 'bundle';
...
export default function SetupPricingPage() {
    ...
    const [pricingModel, setPricingModel] = useState<PricingModel>('one_off');
    ...
    async function handleNext() {
        ...
        setSubmitting(true);
        try {
            // TODO: savePricing(courseId, { pricingModel, price, promoPrice, taxIncluded })
