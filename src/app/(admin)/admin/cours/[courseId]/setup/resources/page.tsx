...
type Resource = { id: string; title: string; format: string };
...
export default function SetupResourcesPage() {
    ...
    const [videoIntro, setVideoIntro] = useState(true);
    const [videoConclusion, setVideoConclusion] = useState(true);
    const [videoModules, setVideoModules] = useState(true);
    ...
    async function handleNext() {
        ...
        setSubmitting(true);
        try {
            // TODO: saveResources(courseId, { videoIntro, videoModules, videoConclusion, resources })
