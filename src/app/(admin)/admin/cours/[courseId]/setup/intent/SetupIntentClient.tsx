...
import { ChevronLeft, Target, Users, CheckCircle2, AlertTriangle, BookOpenCheck, Sparkles, Info, X } from 'lucide-react';
...
export default function SetupIntentClient({ courseId, initialIntent }: SetupIntentClientProps) {
    ...
    return (
        <div className="space-y-6">
            ...
            <CourseWizardFooter
                backHref={`/admin/cours/${courseId}/setup/identity`}
