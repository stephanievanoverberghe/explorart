...
export default function SetupIntentPage({ params }: { params: { courseId: string } }) {
    ...
    const [teachingStyle, setTeachingStyle] = useState<'guided' | 'practice' | 'analysis'>('guided');
    const [tone, setTone] = useState<'soft' | 'direct' | 'playful'>('soft');
    ...
    async function saveDraft() {
        ...
        setSubmitting(true);
        try {
            // TODO: server action updateCourseIntent(courseId, {...})
            const now = new Date();
