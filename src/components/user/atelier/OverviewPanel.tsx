...
function ContinueReadingCard() {
    return (
        <div className="relative overflow-hidden rounded-3xl border border-perl/60 bg-ivory/95 p-5 md:p-6 shadow-sm">
            <div className="pointer-events-none absolute inset-0 opacity-[0.16] mix-blend-soft-light bg-[radial-gradient(circle_at_0%_0%,#3c6e5a_0,transparent_52%),radial-gradient(circle_at_100%_100%,#b45c77_0,transparent_55%)]" />
            <div className="relative flex h-full flex-col gap-3">
                <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="rounded-full bg-white/70 px-2.5 py-0.5 text-[0.7rem] text-main/55">Suggestion douce</span>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <p className="flex items-center gap-2 text-sm text-main/70">
                ...
                <div className="mt-auto pt-2">
                    <Link
                        ...
                        className="inline-flex items-center gap-2 rounded-full bg-main px-4 py-2.5 text-sm font-medium text-ivory shadow-sm transition hover:bg-main/90"
                    >
...
function MiniFormationCard() {
    return (
        <div className="relative flex flex-col gap-3 rounded-3xl border border-perl/60 bg-white/95 p-5 md:p-6 shadow-sm">
            <div className="flex items-center justify-between gap-2">
            ...
            <div className="pt-2">
                <Link
                    ...
                    className="inline-flex w-full items-center justify-center rounded-full border border-perl/70 bg-ivory px-4 py-2.5 text-sm font-medium text-main/80 transition hover:border-sage/70 hover:bg-sage/5"
                >
        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between gap-2">
                <div>
                    ...
                    <h2 className="font-serif-title text-lg md:text-xl text-main">Progression par pilier</h2>
                </div>
            ...
            <div className="grid gap-3 md:grid-cols-2">
                {mockPillarProgress.map((pillar) => (
                    ...
                    >
                        ...
                        <p className="text-[0.75rem] text-main/60">Clique pour voir les articles de ce pilier.</p>
                    </Link>
                ))}
            </div>
        </div>
...
function FavoritesSummaryCard() {
    return (
        <aside className="rounded-3xl border border-perl/60 bg-white/95 p-5 shadow-sm space-y-3">
            <div className="flex items-center justify-between gap-2">
                <div>
                    <p className="text-[0.7rem] uppercase tracking-[0.18em] text-main/60">Favoris</p>
                    <h2 className="font-serif-title text-lg text-main">Tes étoiles récentes</h2>
                </div>
                <div className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-rose/10">
                    <Star className="h-4 w-4 text-rose/80" />
                </div>
            </div>
            ...
            <ul className="space-y-2.5">
                {mockFavorites.map((fav) => (
                    <li key={fav.href}>
                        <Link href={fav.href} className="group -mx-3 flex flex-col gap-0.5 rounded-2xl px-3 py-2 hover:bg-ivory/85 transition">
            ...
            <p className="pt-1 text-[0.75rem] text-main/55">Plus tard, tu pourras épingler n’importe quel article et le retrouver ici en un clic.</p>
        </aside>
    );
}
