...
Ce n’est pas la quantité qui compte, mais la **continuité douce**. Un geste répété avec bienveillance vaut plus qu’une séance parfaite, faite une seule fois.
    ...
    },
    {
        ...
        hero: {
            ...
            alt: 'Carnet ouvert avec quelques traits et cercles dessinés rapidement au crayon.',
        },
        sections: [
            // 1) INTRO
            {
...
Ce n’est pas la quantité qui compte, mais la **continuité douce**. Un geste répété avec bienveillance vaut plus qu’une séance parfaite, faite une seule fois.
    ...
    {
        slug: 'tester-les-pressions-du-crayon',
        title: 'Tester les pressions : comprendre comment ton trait respire',
        excerpt: 'Un exercice simple et sensoriel pour apprivoiser la pression de ton crayon. Quelques lignes suffisent pour changer complètement la fluidité de ton geste.',
        level: 'intermediate',
        pillar: 'dessin-peinture',
        format: 'tutorial',
        readingTime: '7 min',
        coverImage: '/images/articles/dessiner-peindre/oser-premier-trait/exercice-1.png',
        subcategory: 'dp-techniques-et-matieres',
        publishedAt: '2025-05-20',
        hero: {
            src: '/images/articles/dessiner-peindre/oser-premier-trait/exercice-1.png',
            alt: 'Feuille remplie d’échantillons de traits du plus léger au plus appuyé.',
        },
        sections: [
            // 1) INTRO
            {
...
Ce n’est pas la quantité qui compte, mais la **continuité douce**. Un geste répété avec bienveillance vaut plus qu’une séance parfaite, faite une seule fois.
    ...
    },
    {
        ...
        title: 'Le trait gestuel : dessiner sans réfléchier',
