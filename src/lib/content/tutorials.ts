...
S’il y a un geste qui libère instantanément la main, c’est le cercle.

Pas le cercle parfait, mathématique et symétrique.  
Le cercle imparfait, vivant, un peu tremblé — celui qui épouse ton rythme plutôt qu’il ne le contraint.

### Étapes

1. Pose ton crayon sur la feuille, sans pression excessive.  
2. Commence un cercle lent, très lent, presque silencieux.  
3. Ne cherche pas la symétrie : laisse le cercle se déformer.  
4. Continue la boucle sans lever le crayon.  
5. Fais 3 à 5 tours.  
6. Recommence, mais un peu plus vite.  
7. Alterne : grands, petits et moyens cercles.
                    `.trim(),
                                            },
                                        ],
                                        right: [
                                        ...
                                        left: [
                                            {
                                                kind: 'rich-text',
                                                id: 'exercice-3-texte',
                                                title: 'Exercice 3 : Le trait lent',
                                                markdown: `
### Objectif de l’exercice

Le trait lent est un exercice presque méditatif.

Il t’apprend à ralentir, à écouter ton geste, à développer la précision **et** la présence.

### Étapes

1. Pose ton crayon sur le papier, juste une seconde.  
2. Inspire doucement.  
3. En expirant, trace une ligne très lente, comme si tu versais du miel.  
4. Va d’un point A à un point B en laissant ton bras guider le geste.  
5. Observe la sensation sous tes doigts : le crayon qui glisse, accroche, hésite…  
6. Recommence, mais encore plus lentement.  
7. Varie : ligne courte, longue, oblique, verticale.
                    `.trim(),
                                            },
                                        ],
                                        right: [
...
Il raconte tout — la vitesse, la pression, l’intention.
            ...
            // 8) PROGRESSION
            {
                ...
                blocks: [
                    {
                        kind: 'rich-text',
                        id: 'progression-main-libre',
                        title: 'Comment savoir si ta main devient plus libre ?',
                        markdown: `
La progression en dessin ne se voit pas toujours au premier coup d’œil.  
Souvent, elle se **sent** avant de se voir.

Et c’est exactement ce qu’on cherche ici : un geste plus vivant, une main plus libre, une relation plus douce avec le trait.
                        `.trim(),
                    },
                    {
                        kind: 'two-cols',
                        id: 'signes-progression',
                        layout: 'balanced',
                        left: [
                            {
                                kind: 'rich-text',
...
- tes lignes sont plus amples, plus souples,  
- ton poignet change de direction plus facilement,  
- les cercles improvisés sont moins “coupés”, plus fluides.  

Ces petits changements, presque discrets, sont déjà de grandes victoires.
                                `.trim(),
                            },
                        ],
                        right: [
                            {
                                ...
                                markdown: `
Parfois, la vraie progression se passe en toi :

- moins de crispation dans les doigts,  
- une respiration plus calme quand tu traces,  
- moins de jugement immédiat,  
- une sensation de “me laisser porter par le geste”,  
- un plaisir nouveau dans l’idée de dessiner.  

Quand tu sens que ton trait devient un moment agréable plutôt qu’un défi, ta main est déjà en train de se libérer.
                                `.trim(),
                            },
                        ],
                    },
                    {
                        ...
                        id: 'test-20-secondes',
                        tone: 'pedagogic',
                        title: 'Test en 20 secondes pour mesurer ta progression',
                        markdown: `
Fais ceci :

1. Trace une ligne comme tu l’aurais faite avant ce tutoriel.  
2. Ensuite, fais un trait lent, calme, avec respiration.  
3. Compare les deux.

La différence est parfois subtile… parfois énorme.  
Dans tous les cas, elle est réelle.
                        `.trim(),
                    },
                ],
            },
                ...
                blocks: [
                    {
                        ...
                        markdown: `
On croit souvent qu’un “avant/après” doit être spectaculaire : un trait tremblant qui devient parfait, une main maladroite qui devient experte.

Mais dans l’apprentissage du dessin — surtout dans la libération du geste — les transformations sont plus fines, plus intérieures, plus sensibles.
...
Et pourtant… elles comptent davantage que tout.
                    ...
                    {
                        kind: 'two-cols',
                        id: 'debutants-vs-apres',
                        layout: 'sidebar-right',
                        left: [
                            {
                                kind: 'rich-text',
                                id: 'ce-que-font-les-debutants',
                                title: 'Ce que font les débutants au début',
                                markdown: `
Avant d’exercer la main, la plupart des gens :

- appuient trop fort,  
- tracent trop vite,  
- cherchent à “bien faire”,  
- veulent être droits, propres, maîtrisés,  
- ont le souffle court sans s’en rendre compte,  
- se jugent au premier trait.  

Cette tension, souvent invisible, se glisse partout : dans la main, le poignet, les épaules… et dans la tête.
                                `.trim(),
                            },
                        ],
                        right: [
                            {
                                kind: 'rich-text',
                                id: 'ce-que-tu-vas-faire',
                                title: 'Ce que tu vas faire maintenant',
                                markdown: `
Avec ces exercices, ton geste va changer — peut-être pas ton dessin tout de suite, mais ton **rapport** au dessin :

- ta main sera plus souple,  
- ton trait plus vivant,  
- ta pression plus douce,  
- ton poignet plus mobile,  
- ta respiration plus calme,  
- ton regard plus indulgent.  

Le dessin ne devient pas “meilleur”.  
Il devient possible.  
Et c’est cela, la vraie progression.
                    ...
                    },
                    {
                        ...
                        tone: 'soft',
                        title: 'Pourquoi la différence est parfois subtile… mais essentielle',
                        markdown: `
Tu vas peut-être regarder ta feuille et te dire :  
“Je ne vois pas une énorme différence.”

C’est normal.

Le travail que tu fais ici est un travail interne :
                ...
                blocks: [
                    {
                        ...
                        markdown: `
### 1) À quelle fréquence pratiquer ces exercices ?

Le mieux : un peu tous les jours, même 3 minutes.  
Mais si tu manques de temps, une seule séance par semaine suffit déjà à assouplir la main.  

Ce n’est pas la durée qui compte, c’est la **régularité douce**.

### 2) Et si mes traits tremblent encore ?

Alors tu progresses.  
Un trait qui tremble, c’est une main qui apprend, pas une main qui échoue.  

Avec le temps, le tremblement devient rythme, puis fluidité.  
Ne le combats pas : accompagne-le.

### 3) Combien de temps avant de sentir une différence ?

Très vite.  
Certaines personnes ressentent une amélioration dès la première séance : respiration plus calme, geste plus libre, moins de tension.  

Mais pour une vraie fluidité, compte 7 à 14 jours de pratique légère.  
                ...
                blocks: [
                    {
                        ...
                        markdown: `
Tu viens de faire quelque chose d’important, même si cela te semble simple :

- tu as donné un peu de temps à ta main,  
- un peu de souffle à ton geste,  
- un peu de douceur à ton regard.  

Ces trois exercices ne sont pas de “petits” exercices.  
Ce sont des portes : vers un dessin plus libre, plus fluide, plus vivant — un dessin qui te ressemble.

Souviens-toi : tu n’as pas besoin d’être “doué”.  
Tu n’as pas besoin d’être parfait.  

Tu as juste besoin d’être là, présent·e, crayon en main, avec l’envie d’essayer.

Chaque trait que tu poses est une conversation avec toi-même.  
Et aujourd’hui, tu as commencé à l’écouter.

Prends ton temps, recommence demain, refais juste un cercle ou un trait lent si tu n’as que deux minutes.  
Ce geste-là, même minuscule, nourrit déjà ton art.

Tu es en train de construire quelque chose :

- un geste qui respire,  
- un regard qui s’ouvre,  
- et une main qui apprend à danser.  

**Continue. Doucement, mais continue.  
Ton trait n’attend que toi.**
                        `.trim(),
                    },
                ],
            },
